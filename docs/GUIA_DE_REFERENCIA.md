...
1. Filosofia "Adianti" Adaptada ao Node.js
...
1. Estratégias de Multi-tenancy no Framework
...
Multi Tenant (Shared DB): Dados de todos os tenants residem na mesma tabela, com filtro obrigatório por company_id injetado no nível do ORM (Prisma).
...
1. Ciclo de Vida do Teste Online (Sandbox)
...
1. Exportação e Segurança de Propriedade Intelectual
